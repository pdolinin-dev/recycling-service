...
class RecyclingPointControllerTest {
    ...
    void setUp() {
        ...
        recyclingPointDto.setCategories(new HashSet<>());
        ...
        recyclingPointDto1.setCategories(new HashSet<>());
    }
    ...
    void getAllPoints_success_return200() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/recycling-points"))
                ...
                .andExpect(jsonPath("$[0].name").value("test_type_1"))
                ...
                .andExpect(jsonPath("$[0].type.name").value("test_type_1"))
